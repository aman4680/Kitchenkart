...
import { createDrawerNavigator } from '@react-navigation/drawer';
import { NavigationContainer, DarkTheme } from '@react-navigation/native';
import { DrawerContent } from './dailydairy/screens/DrawerContent';

import MainTabScreen from './dailydairy/screens/MainTabScreen';
import AboutScreen from './dailydairy/screens/AboutScreen';
import SettingsScreen from './dailydairy/screens/SettingsScreen';
import OffersScreen from './dailydairy/screens/OffersScreen';
import NotificationScreen from './dailydairy/screens/NotificationScreen';
...
const App = () => {
  ...
  return (
    <NavigationContainer>
      <AppDrawer.Navigator drawerContent = { props => <DrawerContent {...props} /> } >
        <AppDrawer.Screen name="LoginDrawer" component={MainTabScreen} />
        {/* <AppDrawer.Screen name="MainTab" component={MainTabScreen} /> */}
        <AppDrawer.Screen name="About" component={AboutScreen} />
        <AppDrawer.Screen name="Settings" component={SettingsScreen} />
        <AppDrawer.Screen name="Offers" component={OffersScreen} />
        <AppDrawer.Screen name="Notification" component={NotificationScreen} />
