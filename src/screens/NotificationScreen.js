        ...
        return (
            <Animated.View style={[styles.rowBack, {height: rowHeightAnimatedValue}]}>
                ...
                <TouchableOpacity
                    ...
                    onPress={onClose}
                >
                    <MaterialCommunityIcons name='close-circle-outline' size={25} color="#fff"></MaterialCommunityIcons> 
                </TouchableOpacity>
                <Animated.View
                ...
                >
                    <TouchableOpacity style={[styles.backRightBtn, styles.backRightBtnRight]} onPress={onDelete}>
                        ...
                        >
                            <MaterialCommunityIcons name='trash-can-outline' size={25} color="#fff"></MaterialCommunityIcons>
                        </Animated.View>
                    </TouchableOpacity>
                </Animated.View>
            </Animated.View>
