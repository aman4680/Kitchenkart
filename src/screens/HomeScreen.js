...
const HomeScreen = ({navigation}) => {
  ...
  // const [ favouriteListings, setFavouriteListings ] = useState([]);
    ...
    const handleAddToFav = (listing) => {
      ...
      // navigation.navigate('CreatingList', { listing });
      // const index = favouriteListings.indexOf(listing.id);
      // const index = favouriteListings.findindex(item => itelisting.id);
      // if(index === -1){
      //   favouriteListings = favouriteListings.filter(item => item !== listing.id);
      //   setFavouriteListings(favouriteListings)
      // }
      // return (
      //   <FavouritesList favourites={favouriteListings} />
      // )
    ...
    //     setFavouriteListings(favouriteListings);
    //   } else {
    //     // navigate('CreateList', {listing, onCreateListClose()});
    //     navigate('CreateList', {listing, onCreateListClose()});
