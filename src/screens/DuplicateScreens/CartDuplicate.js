          ...
          <Animated.View style={{margin: 20, opacity: Animated.add(0.1, Animated.multiply(fall, 1.0))}} >                   
            <View style={{flex:1, justifyContent: "space-between", alignItems: "center"}}>
                <View style={styles.cardsWrapper}>
                    ...
                    <QuantitySelector quantity={quantityOne} setQuantity={setQuantityOne} />
                    {/* <Text>Price: 360</Text>                       */}
                    <View style={styles.card}>
                        <View style={styles.cardImgWrapper}>
                            <Image
                    ...
                    <QuantitySelector quantity={quantityTwo} setQuantity={setQuantityTwo} />
                    {/* <Text>Price: 690</Text>                    */}
                </View>        
                <Text style={styles.cardTitle}>Total Price: {quantityOne*180 + quantityTwo*230}</Text> 
                <TouchableOpacity style={styles.commandButton} onPress={() => {navigation.navigate('FinalOrder')} }>
