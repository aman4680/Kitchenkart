...
const listing5Photo = require('../assets/listing5.png');

const EditProfileScreen = () => {    

    const [image, setImage] = useState('https://reactjs.org/logo-og.png');
    // const [image, setImage] = useState("listing5Photo");
        ...
        <View style={styles.container}>
          ...
          <Animated.View style={{margin: 20, opacity: Animated.add(0.1, Animated.multiply(fall, 1.0))}} >
            <View style={{alignItems: 'center'}}>
              ...
              <Text style={{marginTop: 10, marginBottom: 15, fontSize: 18, fontWeight: 'bold'}}>
                Tony
              </Text>
            </View>
